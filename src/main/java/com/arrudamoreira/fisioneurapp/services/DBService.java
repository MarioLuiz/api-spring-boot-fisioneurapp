...
public class DBService {
	...
	public void intanciateTestDatabase() throws ParseException {
		...
		Prontuario pront1 = new Prontuario(null, 378511, "I932", sdf.parse("25/08/2020 10:44"),
				"Paciente reclama de fortes dores na coluna");
		Prontuario pront2 = new Prontuario(null, 853581, "G185", sdf.parse("01/07/2019 07:21"),
				"Paciente reclama de fortes dores na cabeça");
		Prontuario pront3 = new Prontuario(null, 218742, "G587", sdf.parse("21/06/2018 08:31"),
				"Paciente reclama de fortes dores na costas");
		Prontuario pront4 = new Prontuario(null, 128795, "H232", sdf.parse("17/07/2017 20:32"),
